      ...
      <section className="py-16 lg:py-24 border-b border-sage-200 dark:border-graphite-800 bg-ivory/50 dark:bg-graphite-950/60">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-forest-50 dark:bg-forest-950/50 border border-forest-600/20 text-forest-700 dark:text-forest-400 text-xs font-semibold">
            ...
            <span>Support & Governance Inquiries</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-span-5 space-y-6">
              <div className="p-6 rounded-2xl bg-white dark:bg-graphite-900 border border-sage-200 dark:border-graphite-800 shadow-sm space-y-4">
                ...
                <h3 className="text-base font-serif font-bold text-graphite-900 dark:text-ivory">
                ...
                <div className="pt-2 border-t border-sage-100 dark:border-graphite-800 space-y-2.5 text-xs">
                  <div className="flex items-center gap-2 text-graphite-700 dark:text-sage-300">
            ...
            <div className="md:col-span-7">
              <div className="p-6 sm:p-8 rounded-2xl bg-white dark:bg-graphite-900 border border-sage-200 dark:border-graphite-800 shadow-sm">

                {/* Form Header */}
                <h2 className="text-lg font-serif font-bold text-graphite-900 dark:text-ivory mb-1">
                  Send a Message
                </h2>
                <p className="text-xs text-graphite-500 dark:text-sage-400 mb-6">
                  Please provide your details below and our team will get back to you.
                </p>

                {/* Success Alert */}
                {successMessage && (
                  <div className="mb-6 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-xs flex items-start gap-2.5">
                ...
                {/* Global Error Alert */}
                {errorMessage && (
                  <div className="mb-6 p-4 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-700 dark:text-rose-400 text-xs flex items-start gap-2.5">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {/* Name */}
                  <div>
                    <label className="block text-xs font-semibold text-graphite-700 dark:text-sage-200 mb-1.5">
                      Full Name
                    </label>
                    <input
                      type="text"
                      ...
                      className={`w-full px-3.5 py-2.5 rounded-xl text-xs bg-sage-50/60 dark:bg-graphite-950 border ${
                        fieldErrors.name ? 'border-rose-500' : 'border-sage-200 dark:border-graphite-800'
                      } text-graphite-900 dark:text-white placeholder-graphite-400 focus:outline-none focus:ring-2 focus:ring-forest-600/20 focus:border-forest-600 transition-all`}
                    />
                    {fieldErrors.name && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3.5 py-2.5 rounded-xl text-xs bg-sage-50/60 dark:bg-graphite-950 border ${
                        fieldErrors.email ? 'border-rose-500' : 'border-sage-200 dark:border-graphite-800'
                      } text-graphite-900 dark:text-white placeholder-graphite-400 focus:outline-none focus:ring-2 focus:ring-forest-600/20 focus:border-forest-600 transition-all`}
                    />
                    {fieldErrors.email && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3.5 py-2.5 rounded-xl text-xs bg-sage-50/60 dark:bg-graphite-950 border ${
                        fieldErrors.subject ? 'border-rose-500' : 'border-sage-200 dark:border-graphite-800'
                      } text-graphite-900 dark:text-white placeholder-graphite-400 focus:outline-none focus:ring-2 focus:ring-forest-600/20 focus:border-forest-600 transition-all`}
                    />
                    {fieldErrors.subject && (
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className={`w-full px-3.5 py-2.5 rounded-xl text-xs bg-sage-50/60 dark:bg-graphite-950 border ${
                        fieldErrors.message ? 'border-rose-500' : 'border-sage-200 dark:border-graphite-800'
                      } text-graphite-900 dark:text-white placeholder-graphite-400 focus:outline-none focus:ring-2 focus:ring-forest-600/20 focus:border-forest-600 transition-all`}
                    />
                    {fieldErrors.message && (
                  ...
                  <div className="pt-2">
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full inline-flex items-center justify-center gap-2 bg-forest-600 hover:bg-forest-700 disabled:opacity-50 text-white px-6 py-3 rounded-xl text-xs font-semibold shadow-sm transition-all"
                    >
                      {loading ? (
                        <>
